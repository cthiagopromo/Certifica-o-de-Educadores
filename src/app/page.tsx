    ...
    <div className="bg-background">
      <main className="flex flex-col items-center">
        <div className="w-full flex flex-col justify-center items-center gap-12 overflow-hidden px-4 md:px-8">
            <div className="w-full max-w-[1312px] p-14 my-8 bg-primary rounded-[48px] flex flex-col justify-center items-start gap-10">
                <div className="self-stretch flex flex-col lg:flex-row justify-between items-center gap-10">
            ...
            <div className="self-stretch px-4 md:px-16 flex flex-col justify-start items-center gap-20">
                <div className="self-stretch py-14 inline-flex justify-center items-center">
                    <div className="w-full max-w-[1312px] flex flex-col lg:flex-row justify-between items-center gap-10">
                        <div className="w-full lg:w-[651px] inline-flex flex-col justify-start items-start gap-4">
                        ...
                        <div className="w-full lg:w-[556px] inline-flex flex-col justify-center items-start gap-4">
                            <div className="self-stretch flex flex-col sm:flex-row justify-start items-center gap-4">
                                <div className="flex-1 w-full h-60 px-8 bg-muted rounded-3xl shadow-lg flex flex-col justify-center items-start">
                            ...
                            <div className="w-full sm:w-64 h-60 px-8 bg-muted rounded-3xl shadow-lg flex flex-col justify-center items-start">
